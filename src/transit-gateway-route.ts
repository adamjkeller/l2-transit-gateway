...
export interface ITransitGatewayRoute extends cdk.IResource {
  /**
...
abstract class TransitGatewayRouteBase
  extends cdk.Resource
  implements ITransitGatewayRoute
{
...
export class TransitGatewayRoute extends TransitGatewayRouteBase {
  ...
  constructor(scope: Construct, id: string, props: TransitGatewayRouteProps) {
    ...
    if (
      props.transitGatewayAttachment === undefined &&
      props.blackhole === undefined
    ) {
      throw new Error(
        "TransitGatewayRoute must have either blackhole or TransitGatewayAttachment defined, but not both"
      );
    }
    ...
    const resource = new ec2.CfnTransitGatewayRoute(this, "Resource", {
      ...
      transitGatewayRouteTableId:
        props.transitGatewayRouteTable?.transitGatewayRouteTableId || "", //TODO Make Different Interface between internal representation and "app" level
    });
